...
assigned: 2021-11-03 12:00
due: 2021-11-17 23:59:00
---

# What to work on today (11/03)

* If you are not finished with lab04, then work on that first.  You may need to complete Chapter 9 in the zyBook first.
* Then, you may choose to either work on the zyBook chapters 10 and 11 first, on lab05 first.
* Note thab lab05 is due in two weeks, but we'll start talking about Separate Compilation and Makefiles part in lecture on Thursday. 
...
Check on the GitHub webpage for the course organization (<https://github.com/ucsb-cs16-f21>) to find your repo for this lab and make sure that
