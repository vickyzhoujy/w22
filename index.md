...
* All announcements will be posted on either [Gauchospace]({{site.gauchospace}}) or [Campuswire]({{site.campuswire}}).
* Link to [code written in lecture](https://github.com/ucsb-cs16-f21/lectures)
